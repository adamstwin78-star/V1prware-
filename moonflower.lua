...
do
    ...
    local function bsPerformDashStabTech(killerModel)
        ...
        if khrp2 and hrp2 then
            ...
            -- Flip camera 180° — spin the camera to face the same direction
            -- preserving its current height offset from the character
        ...
        -- Step 5: hold rotation locked to killer's LookVector for the hitbox window
